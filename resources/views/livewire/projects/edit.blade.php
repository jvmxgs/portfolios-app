<form wire:submit.prevent="update" class="flex flex-col gap-10">
    <section class="flex justify-between h-12">
        <h1 class="text-2xl text-dark-blue font-semibold">Update Project</h1>
    ...
    <section class="grid grid-cols-2 gap-8">
        ...
        <label class="text-sm text-dark-blue font-normal flex flex-col gap-2 w-full col-span-2">
            ...
            <textarea wire:model="description" class="rounded border border-azureish-white w-full h-12 text-manatee text-sm focus:border-dark-blue focus:ring-0">
            </textarea>
        </label>
        <div class="justify-self-end col-span-2 text-sm text-dark-blue font-normal relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
            Published
    ...
    .toggle-checkbox:checked {
        @apply: right-0 border-dark-blue;
        right: 0;
        border-color: #0C1E5B;
    }
